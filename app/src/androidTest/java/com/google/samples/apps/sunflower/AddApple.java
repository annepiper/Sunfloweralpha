...
public class AddApple {
    ...
    public void addApple() {
        ViewInteraction tabView = onView(
                allOf(withContentDescription("Plant list"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.tabs),
                                        0),
        ...
        ViewInteraction maskedCardView = onView(
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.plant_watering_header), withText("Watering needs"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.plant_detail_scrollview),
                                        0),
                                1),
                        isDisplayed()));
        textView.check(matches(withText("Watering needs")));
